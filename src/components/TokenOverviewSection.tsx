  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 800px 600px at -300px -300px, rgba(226, 175, 25, 0.40) 0%, rgba(226, 175, 25, 0.35) 8%, rgba(226, 175, 25, 0.28) 15%, rgba(226, 175, 25, 0.20) 25%, rgba(226, 175, 25, 0.12) 35%, rgba(226, 175, 25, 0.08) 45%, rgba(226, 175, 25, 0.05) 55%, rgba(226, 175, 25, 0.03) 65%, rgba(226, 175, 25, 0.015) 75%, rgba(226, 175, 25, 0.008) 85%, rgba(226, 175, 25, 0.002) 95%, transparent 100%) sm:radial-gradient(ellipse 1200px 900px at -400px -400px, rgba(226, 175, 25, 0.50) 0%, rgba(226, 175, 25, 0.45) 8%, rgba(226, 175, 25, 0.38) 15%, rgba(226, 175, 25, 0.30) 25%, rgba(226, 175, 25, 0.22) 35%, rgba(226, 175, 25, 0.15) 45%, rgba(226, 175, 25, 0.10) 55%, rgba(226, 175, 25, 0.06) 65%, rgba(226, 175, 25, 0.03) 75%, rgba(226, 175, 25, 0.015) 85%, rgba(226, 175, 25, 0.005) 95%, transparent 100%)",
        }}
      ></div>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 600px 800px at calc(100% + 300px) 50%, rgba(226, 175, 25, 0.40) 0%, rgba(226, 175, 25, 0.35) 8%, rgba(226, 175, 25, 0.28) 15%, rgba(226, 175, 25, 0.20) 25%, rgba(226, 175, 25, 0.12) 35%, rgba(226, 175, 25, 0.08) 45%, rgba(226, 175, 25, 0.05) 55%, rgba(226, 175, 25, 0.03) 65%, rgba(226, 175, 25, 0.015) 75%, rgba(226, 175, 25, 0.008) 85%, rgba(226, 175, 25, 0.002) 95%, transparent 100%) sm:radial-gradient(ellipse 900px 1200px at calc(100% + 400px) 50%, rgba(226, 175, 25, 0.50) 0%, rgba(226, 175, 25, 0.45) 8%, rgba(226, 175, 25, 0.38) 15%, rgba(226, 175, 25, 0.30) 25%, rgba(226, 175, 25, 0.22) 35%, rgba(226, 175, 25, 0.15) 45%, rgba(226, 175, 25, 0.10) 55%, rgba(226, 175, 25, 0.06) 65%, rgba(226, 175, 25, 0.03) 75%, rgba(226, 175, 25, 0.015) 85%, rgba(226, 175, 25, 0.005) 95%, transparent 100%)",
        }}
      ></div>
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 sm:w-80 sm:h-80 md:w-84 md:h-84 z-10 relative">
              ...
              >
                ...
                <circle
                  ...
                  strokeLinecap="round"
                  className="transition-all duration-1000 sm:stroke-[6]"
                  style={{
                    filter:
                      "drop-shadow(0 0 8px rgba(51, 95, 255, 0.6)) sm:drop-shadow(0 0 12px rgba(51, 95, 255, 0.8))",
                  }}
                />
                ...
                <circle
                  ...
                  style={{
                    filter:
                      "drop-shadow(0 0 8px rgba(226, 175, 25, 0.6)) sm:drop-shadow(0 0 12px rgba(226, 175, 25, 0.8))",
                  }}
                />
                ...
                <circle
                  ...
                  style={{
                    filter:
                      "drop-shadow(0 0 8px rgba(255, 91, 47, 0.6)) sm:drop-shadow(0 0 12px rgba(255, 91, 47, 0.8))",
                  }}
                />
                ...
                <circle
                  ...
                  style={{
                    filter:
                      "drop-shadow(0 0 8px rgba(50, 255, 122, 0.6)) sm:drop-shadow(0 0 12px rgba(50, 255, 122, 0.8))",
                  }}
                />
              </svg>
              ...
              <div className="absolute -top-1 -left-12 sm:-left-20">
                <div className="flex items-start">
                  ...
                  <svg
                    ...
                    viewBox="0 0 138 95"
                    fill="none"
                    className="mt-1 sm:w-[110px] sm:h-[64px]"
                    style={{
                      filter:
              ...
              <div className="absolute -bottom-3 -left-10 sm:-left-16">
                <div className="flex items-end">
                  ...
                  <svg
                    ...
                    viewBox="0 0 139 95"
                    fill="none"
                    className="mb-1 sm:w-[110px] sm:h-[64px]"
                    style={{
                      filter:
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                >
                  <div className="text-sm sm:text-base md:text-lg lg:text-xl font-satoshi text-white mb-1">
        ...
        {/* Bottom Info Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-3 sm:gap-4 lg:gap-6 max-w-6xl mx-auto">
          {/* Taxation Card - Medium */}
          <div
            className="rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-700/30 lg:col-span-2"
            style={{
              background: "rgba(255, 255, 255, 0.05)",
            }}
          >
            <h3 className="font-heading text-sm sm:text-base font-satoshi text-[#EDEDED] mb-2 sm:mb-3">
              Taxation
            </h3>
          ...
          <div
            className="rounded-lg sm:rounded-xl p-3 border border-gray-700/30 sm:col-span-2 lg:col-span-3"
            style={{
              background: "rgba(255, 255, 255, 0.05)",
            }}
          >
